export const reportHeaderXls = {
  ...
  fieldNamesEn: [
    ...
    'Name of batch',
    'File to KMZ batch',
    'Sustainability contract documents',
    'HASH list of signatures Sustainability contrats',
    'Person who signs Sustainability contrats',
    'Hectares Sustainability contrats',
    'Batch signature date Sustainability contrats',
    'Land use contract documents',
    'HASH list of signatures Use of Land contrats',
    'Names of whom sign Use of Land contrats',
    'Hectares Use of Land contracts',
    'Batch signature date Use of Land contrats',
    'Planned hectares SOWING',
    'Date of realization of the batch SOWING',
    'Realization area SOWING',
    'Total area signed SOWING',
    'Signature date of the realization of the batch SOWING',
    'Total area with eivdence SOWING',
    'Link Sowing signature file to download',
    'Link evidence SOWING',
    'Amount of realization per batch SOWING',
    'Planned hectares HARVEST',
    'Date of realization of the batch HARVEST',
    'Realization area HARVEST',
    'Total area signed HARVEST',
    'Signature date of the realization of the batch HARVEST',
    'Total area with eivdence HARVEST',
    'Link Harvest signature file to download',
    'Link evidence HARVEST',
    'Amount of realization per batch HARVEST',
    'Planned hectares SPRAYING',
    'Date of realization of the batch SPRAYING',
    'Realization area SPRAYING',
    'Total area signed SPRAYING',
    'Signature date of the realization of the batch SPRAYING',
    'Total area with eivdence SPRAYING',
    'Link Spraying signature file to download',
    'Link evidence SPRAYING',
    'Amount of realization per batch SPRAYING',
    'Planned hectares FERTILIZATION',
    'Date of realization of the batch FERTILIZATION',
    'Realization area FERTILIZATION',
    'Total area signed FERTILIZATION',
    'Signature date of the realization of the batch FERTILIZATION',
    'Total area with eivdence FERTILIZATION',
    'Link Fertilization signature file to download',
    'Link evidence FERTILIZATION',
    'Amount of realization per batch FERTILIZATION',
    'Planned hectares ACTIVITIES',
    'Date of realization of the batch ACTIVITIES',
    'Realization area ACTIVITIES',
    'Total area signed ACTIVITIES',
    'Signature date of the realization of the batch ACTIVITIES',
    'Total area with eivdence ACTIVITIES',
    'Link Activities signature file to download',
    'Link evidence ACTIVITIES',
    'Amount of realization per batch ACTIVITIES',
    'Email of the producers',
    'Telephone number of the producers',
    'Last monitoring date',
    'Yield unit',
    'Yield',
    'Estimated harvest date',
    'Signature date of the total monitoring'
  ],
  fieldNamesEs: [
    'CUIT',
    'razon social',
  ...
  fieldNamesPt: [
    ...
    'Cultivo',
    'Nome do cultivo',
    'Volume tons (ha x rinde en ton)',
    'Has',
    'Rendimento',
    'Engenheiro responsável / eis',
    'Data estimada de semeadura',
    'Data estimada de coleita',
    'Data de registração do cultivo',
    'Departamento de lote',
    'Estado do lote',
    'Localização KMZ',
    'Estebelecimento ou agrupador de lotes',
    'Nome do lote',
    'Arquivo a KMZ lote',
    'Documentos de acordo de sustentabilidade',
    'Listado de HASH de assinaturas ACORDOS SUSTENTABILIDADE',
    'Nome dos firmantes ACORDOS SUSTENTABILIDADE',
    'HAS ACORDO SUSTENTABILIDADE',
    'Data de assinatura',
    'Documentos de acordo de utilização do solo',
    'Listado de HASH de assinaturas ACORDOS de UTILIZAÇÃO DO SOLO',
    'Nome dos assinantes ACORDOS de UTILIZAÇÃO DO SOLO',
    'HAS ACORDOS de UTILIZAÇÃO DO SOLO',
    'Data de assinatura do lote ACORDOS de UTILIZAÇÃO DO SOLO',
    'Superficie de planejamento de ATIVIDADE DE SEMEADURA',
    'Data de realização do lote ATIVIDADE SEMEADURA',
    'Superficie da Realização da ATIVIDADE SEMEADURA',
    'Total Superficie assinada da ATIVIDADE SEMEADURA',
    'Data de assinatura x realização do lote por ATIVIDADE SEMEADURA',
    'Superficie com evidência x ATIVIDADE SEMEADURA',
    'Link descarregamento de arquivos de assinaturas Semeadura',
    'Link evidências Semeadura',
    'Quantidade de realização por Lote de ATIVIDADE SEMEADURA',
    'Superficie de Planejamento da ATIVIDADE COLEITA',
    'Data de realização do lote ATIVIDADE COLEITA',
    'Superficie da realização da ATIVIDADE COLEITA',
    'Total Superficie assinada da ATIVIDADE COLEITA',
    'Data de assinatura x realização do lote por ATIVIDADE COLEITA',
    'Superficie com evidência x ATIVIDADE COLEITA',
    'Link de descarregamento de arquivos de assinaturas Coleita',
    'Link evidências Coleita',
    'Quantidade de realização por Lote de ATIVIDADE COLEITA',
    'Superficie de planejamento da ATIVIDADE PULVERIZAÇÃO',
    'Data de realização do lote ATIVIDADE PULVERIZAÇÃO',
    'Superficie da Realização da ATIVIDADE PULVERIZAÇÃO',
    'Total Superficie assinada da ATIVIDADE PULVERIZAÇÃO',
    'Data de Assinatura x realização do lote por ATIVIDADE PULVERIZAÇÃO',
    'Superficie com evidência x ATIVIDADE PULVERIZAÇÃO',
    'Link de descarregamento de arquivos de assinaturas Pulverização',
    'Link evidências Pulverização',
    'Quantidade de realização por Lote de ATIVIDADE APLICAÇÃO',
    'Superficie de Planejamento da ATIVIDADE FERTILIZAÇÃO',
    'Data de realização do lote ATIVIDADE FERTILIZAÇÃO',
    'Superficie da Realização da ATIVIDADE FERTILIZAÇÃO',
    'Total Superficie assinada da ATIVIDADE FERTILIZAÇÃO',
    'Data de Assinatura x realização do lote por ATIVIDADE FERTILIZAÇÃO',
    'Superficie com evidência x ATIVIDADE FERTILIZAÇÃO',
    'Link de descarregamento de arquivos de assinaturas Fertilização',
    'Link evidências Fertilização',
    'Quantidade de realização por Lote de ATIVIDADE FERTILIZAÇÃO',
    'Superficie de planejamento da ATIVIDADE LAVOURAS',
    'Data de realização do lote ATIVIDADE LAVOURAS',
    'Superficie da Realização da ATIVIDADE LAVOURAS',
    'Total Superficie assinada da ATIVIDADE LAVOURAS',
    'Data da assinatura x realização do lote ATIVIDADE LAVOURAS',
    'Superficie com evidência x ATIVIDADE LAVOURAS',
    'Link de descarregamento de arquivos de assinaturas Lavouras',
    'Link evidências Lavouras',
    'Quantidade de realização por Lote de ATIVIDADE LAVOURAS',
    'Email dos produtores',
    'Telefone dos Produtores',
    'Última data de monitoramento',
    'Unidade de rendimento',
    'Rendimento',
    'Data Estimativa de coleita',
    'Data da assinatura total do monitoramento'
  ],
  fieldNames: [
    'CUIT',
    'razon social',
