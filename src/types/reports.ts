export const reportHeaderXls = {
  ...
  fieldNamesPt: [
    ...
    'cultivo',
    'nome do cultivo',
    'Volume TON (tem x rendimentos em TON)',
    'superfície',
    'Rinde',
    'Engenheiro (s) Responsável (es)',
    'Data Estimada de Plantio',
    'Fecha Estimada de Cosecha',
    'Data Estimada de Colheita',
    'Departamento de lote',
    'Province Lot',
    'Localização KMZ',
    'Estabelecimento ou agrupamento em lote',
    'Nome do lote',
    'Arquivo para KMZ LOT',
    'Documentos do Acordo de Sustentabilidade',
    'HASH lista de assinaturas ACORDOS DE SUSTENTABILIDADE',
    'Nome Signatários ACORDOS DE SUSTENTABILIDADE',
    'VOCÊ ACEITOU SUSTENTABILIDADE',
    'Assinatura do lote Data ACORDO DE SUSTENTABILIDADE',
    'Documentos do Acordo de Uso da Terra',
    'HASH lista de assinaturas ACORDOS DE USO DO TERRENO',
    'Nome Signatários ACORDOS DE USO DO TERRENO',
    'VOCÊ ACEITOU USAR TERRA',
    'Data de Assinatura do Lote ACORDOS DE USO DO TERRENO',
    'Área de Planejamento de ATIVIDADES de Semeadura',
    'Data de realização do lote de ATIVIDADE DE PLANTAS',
    'Superfície da Realização da ATIVIDADE DE SEMEADURA',
    'Área total assinada da ATIVIDADE DE SEMENTE',
    'Assinatura Data x realização do lote por ATIVIDADE DE SEMEADURA',
    'Superfície com evidência x ATIVIDADE DE SEMENTE',
    'Semeando link de download de arquivos de assinatura',
    'Link evidencia a semeadura',
    'Quantidade de realização por lote de ATIVIDADE DE SEMEADURA',
    'Área de Planejamento da ATIVIDADE DE COLHEITA',
    'Dados de conclusão do lote ATIVIDADE DE COLHEITA',
    'Área de Realização da ATIVIDADE DE COLHEITA',
    'Área total identificada por ATIVIDADE DE COLHEITA',
    'Assinatura Data x realização do lote por ATIVIDADE DE COLHEITA',
    'Superfície com evidência x ATIVIDADE DE COLHEITA',
    'Link para download de arquivos de assinatura de colheita',
    'Link de evidências de colheita',
    'Quantidade de realização por lote de ATIVIDADE DE COLHEITA',
    'Área de Planejamento da ATIVIDADE DE APLICAÇÃO',
    'Data de conclusão do lote APLICAÇÃO DE ATIVIDADE',
    'Superfície de Realização da ATIVIDADE DE APLICAÇÃO',
    'Área total assinada da ATIVIDADE DE APLICAÇÃO',
    'Assinatura Data x realização do lote por APLICAÇÃO DE ATIVIDADE',
    'Superfície com evidência x APLICAÇÃO DE ATIVIDADE',
    'Link para download do arquivo de assinatura do aplicativo',
    'Link de evidência de aplicação',
    'Quantidade de realização por lote de ATIVIDADE DE APLICAÇÃO',
    'Área de Planejamento da ATIVIDADE DE FERTILIZAÇÃO',
    'Data de realização do lote ATIVIDADE DE FERTILIZAÇÃO',
    'Superfície de Realização da ATIVIDADE DE FERTILIZAÇÃO',
    'Área total sinalizada da ATIVIDADE DE FERTILIZAÇÃO',
    'Data de assinatura x realização do lote por ATIVIDADE DE FERTILIZAÇÃO',
    'Superfície com evidência x ATIVIDADE DE FERTILIZAÇÃO',
    'Link para download do arquivo de assinatura de fertilização',
    'Evidências de fertilização de link',
    'Quantidade de realização por lote de ATIVIDADE DE FERTILIZAÇÃO',
    'Área de Planejamento para ATIVIDADE DE TRABALHO',
    'Data de realização do lote TRABALHO DE ATIVIDADE',
    'Superfície de Realização da ATIVIDADE DE TRABALHO',
    'Área total assinada da ATIVIDADE DE TRABALHO',
    'Assinatura data x realização do lote por ATIVIDADE DE TRABALHO',
    'Superfície com evidência x ATIVIDADE DE TRABALHO',
    'Link para download do arquivo de assinatura de trabalho',
    'Trabalho de evidências de link',
    'Quantidade de realização por lote de ATIVIDADE DE TRABALHO',
    'Correio dos Produtores',
    'Telefone dos Produtores',
    'Última data de monitoramento',
    'Rendimento da unidade',
    'Render',
    'Data Estimada de Colheita',
    'Data de assinatura total do monitoramento'
  ],
  fieldNames: [
    'CUIT',
    'razon social',
